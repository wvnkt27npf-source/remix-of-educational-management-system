...
<body>
        ...
        <div class="news-card" onclick="openNewsModal(<?= $index ?>)" style="cursor: pointer;">
          ...
          <?php else: ?>
            <div class="news-card-image" style="display: flex; align-items: center; justify-content: center;">
              <i class="bi bi-newspaper" style="font-size: 48px; color: var(--royal); opacity: 0.3;"></i>
            </div>
          <?php endif; ?>
          ...
          <span class="news-read-more" style="color: var(--royal); font-weight: 600; font-size: 0.9rem; display: inline-flex; align-items: center; gap: 6px; margin-top: 12px;">
  ...
  <!-- News Modal -->
  <div class="news-modal-overlay" id="newsModalOverlay" onclick="closeNewsModal()" style="display: none; position: fixed; inset: 0; background: rgba(0,0,0,.75); z-index: 9999; padding: 20px; overflow-y: auto;">
    <div class="news-modal" onclick="event.stopPropagation()" style="max-width: 800px; margin: 40px auto; background: white; border-radius: 16px; overflow: hidden; animation: modalFadeIn 0.3s ease;">
      <button onclick="closeNewsModal()" style="position: absolute; top: 15px; right: 15px; background: var(--dark); color: white; border: none; width: 40px; height: 40px; border-radius: 50%; font-size: 1.2rem; cursor: pointer; z-index: 10;">
        <i class="bi bi-x-lg"></i>
      </button>
      <div id="newsModalImage" style="width: 100%; height: 300px; object-fit: cover; background: var(--gray-100);"></div>
      <div style="padding: 40px;">
        <div id="newsModalDate" style="color: var(--royal); font-weight: 600; font-size: 0.85rem; margin-bottom: 12px; text-transform: uppercase; letter-spacing: 1px;"></div>
        <h3 id="newsModalTitle" style="font-size: 2rem; margin-bottom: 25px; color: var(--dark);"></h3>
        <div id="newsModalContent" style="color: var(--gray-500); line-height: 2; font-size: 1.05rem; white-space: pre-line;"></div>
      </div>
    </div>
  </div>
  ...
  <script>
    ...
    function openNewsModal(index) {
      ...
      if (news.image) {
        ...
        imgDiv.innerHTML = '<div style="width:100%;height:300px;display:flex;align-items:center;justify-content:center;background:var(--gray-100);"><i class="bi bi-newspaper" style="font-size:80px;color:var(--royal);opacity:0.2;"></i></div>';
      }
